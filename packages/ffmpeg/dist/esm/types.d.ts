...
export type FFMessageData = FFMessageLoadConfig | FFMessageExecData | FFMessageWriteFileData | FFMessageReadFileData | FFMessageDeleteFileData | FFMessageRenameData | FFMessageCreateDirData | FFMessageListDirData | FFMessageDeleteDirData | FFMessageMountData | FFMessageUnmountData | FFMessageWriteFrameData | FFMessageReadFrameData | FFMessageInitFilterData | FFMessageProcessFrameData | FFMessageCloseFilterData;
...
export type CallbackData = FileData | ExitCode | ErrorMessage | LogEvent | ProgressEvent | IsFirst | OK | Error | FSNode[] | {
    frameData: Uint8Array;
    timestamp: number;
} | null | undefined;
