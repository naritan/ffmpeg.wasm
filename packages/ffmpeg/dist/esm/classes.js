...
export class FFmpeg {
     ...
     * @category WebCodecs
     */
    initFilter = (filterGraph, inputWidth, inputHeight, outputWidth, outputHeight, { signal } = {}) => this.#send({
     ...
     * @category WebCodecs
     */
    processFrame = (frameData, timestamp, { signal } = {}) => this.#send({
