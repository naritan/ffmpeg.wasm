...
export declare class FFmpeg {
     ...
     * @category WebCodecs
     */
    writeFrame: (frameData: Uint8Array, timestamp: number, { signal }?: FFMessageOptions) => Promise<OK>;
    /**
     * WebCodecs integration: Read a processed frame from ffmpeg
     *
     * @category WebCodecs
     */
    readFrame: ({ signal }?: FFMessageOptions) => Promise<{
     ...
     * @category WebCodecs
     */
    initFilter: (filterGraph: string, inputWidth: number, inputHeight: number, outputWidth: number, outputHeight: number, { signal }?: FFMessageOptions) => Promise<OK>;
    /**
     * WebCodecs integration: Process frame through filter
     *
     * @category WebCodecs
     */
    processFrame: (frameData: Uint8Array, timestamp: number, { signal }?: FFMessageOptions) => Promise<{
        frameData: Uint8Array;
        timestamp: number;
    }>;
    /**
     ...
     * @category WebCodecs
     */
    closeFilter: ({ signal }?: FFMessageOptions) => Promise<OK>;
}
export {};
